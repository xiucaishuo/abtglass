...
if(kfguin)
{
  rightDivHtml = '<div id="rightDiv" style="position:absolute; top:160px; left:0px;">';
...
{
	window.open('http://wpa.qq.com/msgrd?v=3&uin=3094018842&site=qq&menu=yes', '_blank', 'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');
	if(flag==1)
	{
		kf_hidekfpopup();
	}
...
{ 
	...
	var now = new Date();
    img.src = "http://wpa.qq.com/msgrd?v=3&uin=3094018842&site=qq&menu=yes";
